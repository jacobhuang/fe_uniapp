	...
	actions: {
		...
		topShareRank() {
			return new Promise((resolve, reject) => {
				api.topShareRank().then(response => {
		...
		topShareRankRecord() {
			return new Promise((resolve, reject) => {
				api.topShareRankRecord().then(response => {
					if (response.data.code == 200) {
						// console.log(JSON.stringify(response))
						resolve(response)
					} else {
		...
		balanceSummary() {
			return new Promise((resolve, reject) => {
				api.balanceSummary().then(response => {
					if (response.data.code == 200) {
						// console.log(JSON.stringify(response))
						resolve(response)
					} else {
		...
		balanceRecords() {
			return new Promise((resolve, reject) => {
				api.balanceRecords().then(response => {
					if (response.data.code == 200) {
						// console.log(JSON.stringify(response))
						resolve(response)
					} else {
		...
		championReport() {
			return new Promise((resolve, reject) => {
				api.championReport().then(response => {
					if (response.data.code == 200) {
						resolve(response)
					} else {
						resolve(response)
