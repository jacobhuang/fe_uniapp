	...
	<view>
		...
		<!-- 	<swiper class="screen-swiper square-dot"  :indicator-dots="true" :circular="true"
			...
			<view class="cu-bar bg-white solid-bottom" >
				<view class="action">
					<text class='cuIcon-title text-blue'></text>网红模块
				</view>
			</view>
			...
			<view class="cu-bar bg-white solid-bottom margin-top"  >
				<view class="action">
					 <text class='cuIcon-title text-yellow'></text>员工模块
				</view>
			</view>
			<view class="cu-list grid col-3 text-sm">
			...
			<view class="cu-bar bg-white solid-bottom margin-top" >
				<view class="action">
					 <text class='cuIcon-title text-yellow'></text>日常管理
				</view>
			</view>
			<view class="cu-list grid col-3 text-sm">
...
<script>
	import { us,os,base } from '@/common/util/work.js'
