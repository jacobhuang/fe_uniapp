				...
				<view v-if="current == 0">
					...
					<view class="card-wrapper" v-for="(item, index) in schemeList" :key="index">
						<view class="card-content">
                            ...
                            <view style="border-top:1px dotted #CCCCCC;margin:20px 0px;"></view>
                        </view>
                        <view class="card-footer">
                            <view class="btn-wrap">
                                ...
                                <view class="btn-use" @click="useScheme(index)">{{ btnText.use }}</view>
                                 <view class="btn-permission" @click="useScheme(index)">{{ btnText.permission }}</view>
                            </view>
                        </view>
