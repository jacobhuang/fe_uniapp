<template>
	<view >
		<view>
			...
			<view style="width:100vw;display:flex;justify-content:center;background-color:#000;">
			  <u-tabs
			    class="tabs-style"
			    height="150"
			    font-size="12"
			    ...
			    :is-scroll="false"
			    @change="change"
                item-style="width:95px;height:45px;"
			  >
			  </u-tabs>
			</view>
		</view>
		<view class="main-content">
			<view class="scheme-list" >
				<view v-if="current == 0" style="height:100vh;">
					...
					<view class="card-wrapper" v-for="(item, index) in schemeList" :key="index">
                       ...
                       <view class="card-content">
                            ...
                            <view class="hr-line" style="width:100vw;border: .5px solid #EFEFEF;margin:5px 0px;"></view>
                ...
                <view v-if="current == 3" style="height:100vh;">
					<view class="card-wrapper" v-for="(item, index) in schemeList" :key="index">
						<view class="card-tag" v-if="item.default">{{ item.default }}</view>
                        <view class="card-content">
                            <view class="card-line">
                        ...
                        <view class="card-footer">
                            <view class="btn-wrap"><view class="btn-use" @click="useScheme(index)">{{ btnText.use }}</view>
                            </view>
                        </view>
					</view>
				</view>
		...
		methods: {
			...
			initSchemeList() {
				...
				this.schemeList = [...Array(10)].map((v, i) => ({
					default:  '3',
					giftType:  '毛利分红',
					cooperationYears: '订单金额：99元',
                    dividingRatio: '下单时间：2023-03-03',
                    gotTime:'下单客户：-- 订单来源：POS点餐',
					attender: '参与人数' +'0人',
