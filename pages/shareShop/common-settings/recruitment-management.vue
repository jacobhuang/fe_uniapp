			...
			<view class="scheme-list" >
				<view v-if="current == 0">
					...
					<view class="card-wrapper" v-for="(item, index) in schemeList" :key="index">
						  <view class="card-tag-right" v-if="item.default">{{ item.default }}</view>
							  
                        <view style="display: flex;justify-content: space-between;">
							<view>
                               

							    <img src="static/folder.png" alt="" style="width:160px;height:120px;">
							</view>
							<view>
		...
		methods: {
			...
			initSchemeList() {
				...
				this.schemeList = [...Array(10)].map((v, i) => ({
					default:  '仅抽奖使用',
					giftType:  '毛利分红',
					cooperationYears: '奖品1',
                    dividingRatio: '礼包时间：',
                    gotTime:'2022-07-22至2026-07-23',
					attender: '参与人数' +'0人',
